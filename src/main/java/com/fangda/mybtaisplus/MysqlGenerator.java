package com.fangda.mybtaisplus;
...
//		dsc.setUrl("jdbc:mysql://localhost:3306/im?useSSL=true&useLegacyDatetimeCode=false&serverTimezone=America/New_York");
		dsc.setUrl("jdbc:mysql://192.168.5.153:3306/qwd_pv101");
		...
		strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
		 strategy.setInclude(new String[] { "t_loan_apply_check_repeat_log" }); // 需要生成的表
		// strategy.setExclude(new String[]{"test"}); // 排除生成的表
		mpg.setStrategy(strategy);

		// 包配置
		PackageConfig pc = new PackageConfig();
		pc.setParent("com.fangda");
		pc.setModuleName("redis");
